...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /*  LongConsumer#accept(long value) : void : long 값을 받아서 소비한다. */
        LongConsumer longConsumer = num -> System.out.println("입력하신 정수는 " + num + "입니다");
        longConsumer.accept(12345);

        /*  ObjIntConsumer<T>#accept(T t, int value) : void : 객체 T와 int의 값을 받아 소비한다. */
        ObjIntConsumer<java.util.Random> objIntConsumer =
                ((random, value) -> System.out.println("0부터" +value + "전 까지의 난수 발생 " + random.nextInt(value)) );
        objIntConsumer.accept(new java.util.Random(), 10);

        /*  ObjLongConsumer<T>#accept(T t, long value) : void : 객체 T와 long의 값을 받아 소비한다. */

...
public class Applcation {
    ...
    public static void main(String[] args) {
        ...
        * 객체 지향 프로그래밍이란
        *
        * 현실세계의 모든 사건(event)는 객체과 객체의 상호작용에 의해 일어난다는 세계관을
        ...
        * => 따라서 객체를 설계할 때 속성은 부가적이며 적절한 책임을 설계하고
        ...
        * 3. 차동차는 처음에 몸춘 상태로 대기하고 있는다.
        * 4. 카에이서는 먼저 자동차에 시동을 건다.(이미 걸려있는 경우 다시 시동을 걸 수 없다.

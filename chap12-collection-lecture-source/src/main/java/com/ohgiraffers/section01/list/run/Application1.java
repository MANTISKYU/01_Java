...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * => 제이터를 효율적으로 저장하는 자료구조와 데이터를 처리하는 알고리즘을 미리 구현해놓은 클래스
        *
        * */

        /*
        * Collection FrameWork 는 크게 3가지 인터페이스 중 한 가지를 상속받아 구현해두었다.
        * 1. List 인터페이스
        * 2. Set 인터페이스
        * 3. Map 인터페이스
        *
        ...
        * 크기 변경(새로운 더 큰 배열 만들고 옮기기), 요소의 추가, 수정, 석제, 정렬 기능을
        * 미리 메소드로 구현해서 제공한다.
        * */
        ...
        * */
        ...
        // 타입을 저장해서 타입 이외의 인스턴스는 저장하지 않을 수 있다.
        // stringList.add(123);

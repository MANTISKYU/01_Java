...
public class Application {
    ...
    *    수신할 수 있다. 동일한 메시지를 수신하고 처리할 때 객체별로 다르게 할 수 있다는
    *    장점을 가짐
...
//        a2.bite();
        ...
        // 타입 형변환을 잘못 하는 경우
        // 컴파일 시 문제되지는 않지만 런타임시 Exception 발생
        // ((Tiger)a1).bite();
        ...
        * */
        ...
        Animal animal2 = (Animal) new Rabbit(); // 묵시적 형변환

        Rabbit rabbit1 = (Rabbit) animal1; // 명시적 형변환
//        Rabbit rabbit1 = animal1; // 묵시적 형변환 불가능

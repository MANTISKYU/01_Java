...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        IntStream longStream = IntStream.rangeClosed(5, 10);
        longStream.forEach(value -> System.out.print(value + " "));
        System.out.println();

        /*
        * Wrapper 클래스 자료형의 스트림으로 변환이 필요할 떄 boxing을 통해 할 수 있다.
        * doubles(갯수) :
        * boxed() : 기본 타입 스트림인 XXXStream을 박싱하여 Wrapper 타입의 Stream<XXX>로 반환
        * */

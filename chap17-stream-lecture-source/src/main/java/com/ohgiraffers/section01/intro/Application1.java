...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 스트림(Stream)
        * 자바 8버전부터 추가된 기능으로, 컬렉션에 저장된 엘리먼트들을 하나씩 순회하며
        * 처리할 수 있는 기능이다.
        ...
        * 2. 스트림은 일회용이기 떄문에 최종 연산이 일어난 후 다시 스트림을 생성해서 사용해야 한다.
        ...
        * */
        stringList.stream().distinct().sorted(Comparator.reverseOrder()).

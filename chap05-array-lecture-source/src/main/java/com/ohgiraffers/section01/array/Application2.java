...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        // 배열의 할당을 할 시에는 반드시 배열의 크기를 지정해줘야한다.
        // iarr = new int[]; // 크기를 지정해주지 않아서 에러가 발생

        iarr = new int[5];
        carr = new char[5]; // 타입도 맞춰줘야한다.
        ...
        * --> 동일 객체인지 비교할 때 사용할 목적으로 많이 쓰이며, 동등객체를 동일 객체 취급하기 위한 용도로 overring 해서 사용한다.
        * */

        System.out.println("larr2의 hashcode : " + iarr2.hashCode());
        ...
        // 한번 찾아갈 수 있는 주소값을 읿어버린 배열은 다시 참조가 불가능하다.
        darr = null;
